...
-- we dont need the country codes table, but we want to preserve the 2014 population and gdp data
...
-- now, all the data we had in the country codes table for gdp and population is in our country_info table, so we can drop
-- the redundant table
...
-- 1. do olympic tables need a primary key?
...
-- first we have to delete all the entries of the  olympics and income table that do not have a match in country_info
